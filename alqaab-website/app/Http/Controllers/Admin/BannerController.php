...
class BannerController extends DM_BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($this->model->storeData($request, $request->title, $request->title_second, $request->description, $request->url, $request->video, $request->status, $request->rows)) {
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate($rules);
        if ($this->model->updateData($request, $id, $request->title, $request->title_second, $request->description, $request->url, $request->video, $request->status, $request->rows)) {
