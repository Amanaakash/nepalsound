...
class SettingsController extends DM_BaseController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $model->cms_title                           = $request->cms_title;
    ...
    public function getSocialProfiles()
    {
        ...
        $row = DB::table('settings')->select('id', 'social_profile_fb', 'social_profile_twitter', 'social_profile_insta', 'social_profile_linkedin', 'social_profile_youtube', 'social_profile_tiktok', 'social_profile_facebooK_page', 'social_profile_Instagram_page')->first();
    ...
    public function updateSocialProfiles(Request $request, $id)
    {
        ...
        $row->social_profile_tiktok = $request->tiktok;
        $row->social_profile_facebooK_page = $request->social_profile_facebooK_page;
        $row->social_profile_Instagram_page = $request->social_profile_Instagram_page;
        $row->update();
