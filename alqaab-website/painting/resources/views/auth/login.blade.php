...
<div class="content">
    ...
    <form id="login-form" action="{{ route('login') }}" method="POST">
        ...
        <div class="form-group">
            <button class="btn btn-info btn-block g-recaptcha" type="submit" style="cursor: pointer;">Sign In</button>
        </div>
        <div class="social-auth-hr">
        @if($all_view['setting']->site_description)
            <span>{{ $all_view['setting']->site_description }}</span>
        @endif
        </div>
    </form>
