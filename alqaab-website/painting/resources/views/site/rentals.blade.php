            ...
            <div class="icon-container" style="justify-content:center;">
                ...
                @foreach ($rentalCategories as $index => $category)
                    <a href="#section{{ $index + 1 }}">
                        <img src="{{ asset($category->thumbs) }}" alt="{{ $category->title }} Icon" />
...
<section id="section4">
    <div class="rentail-section-a" style="text-align: center;">
        ...
        <img class="sound-img-part" src="@if (isset($data['category'][3])) {{ $data['category'][3]->thumbs }} @endif">
        @else
        <p>
            Image Not Found's !
        </p>
...
<section id="section5" class="">
    <div class="sound-image rentail-section-a" style=" text-align: center; ">
        ...
        <img class="sound-img-part" src="@if (isset($data['category'][4])) {{ $data['category'][4]->thumbs }} @endif">
        @else
        <p>
            Image Not Found's !
        </p>
...
<section id="section6" class="">
    <div class="sound-image rentail-section-a" style=" text-align: center; ">
        ...
        <img class="sound-img-part" src="@if (isset($data['category'][5])) {{ $data['category'][5]->thumbs }} @endif">
        @else
        <p>
            Image Not Found's !
        </p>
        ...
        <section id="section{{ $index + 1 }}" class="">
            <div class="sound-image rentail-section-a" style="text-align: center;">
                @if (isset($category->thumbs))
                    <img class="sound-img-part" src="{{ $category->thumbs }}">
                @else
                    <p>Image Not Found!</p>
                @endif
                    ...
                    @foreach ($catPosts as $row)
                        <div class="row mt-lg-5 mt-3">
                            ...
                            <div class="col-md-6 col-ms-6">
                                <div>
                                    @foreach ($rental_file as $file)
                                        <a href="{{ asset($file->file) }}" class="thumbnail" title="{{ $file->title }}">
                                            <img src="{{ asset($file->file) }}" alt=""
