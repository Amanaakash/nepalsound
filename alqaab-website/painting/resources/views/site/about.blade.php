...
@section('content')
    <section class="background-about-us"
        style="background: url({{ asset($data['featured_pages'][4]->thumbs) }}) no-repeat center center;background-size: cover; background-position: center;background-repeat: no-repeat;position: relative; z-index: 999;margin-top:-100px;">
        <div class="container">
                            ...
                            @foreach ($data['files']->slice(0, 4) as $f)
                                <div class="col-6 mb-3">
                                    <a href="{{ asset($f->file) }}" data-lightbox="models" data-title="caption1"
                                        class="glightbox">
                                        <img src="{{ asset($f->file) }}" class="img-fluid rounded shadow-sm"
                                            alt="Featured Image">
                                    </a>
                                </div>
                            @endforeach
