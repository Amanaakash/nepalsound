                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                        <div class="service-card  text-dark">
                            ...
                            {{-- First Image --}}
                                ...
                                <a href="{{ $row->image }}" data-fancybox="gallery-{{ $row->id }}" data-caption="{{ $row->title }}">
                                    <img src="{{ $row->image }}" alt="{{ $row->title }}" class="img-fluid rounded shadow-sm object-fit-cover" style="height:180px; width:100%; object-fit:cover;">
                                </a>
                                 <h5 class="my-2">
