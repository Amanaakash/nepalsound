...
<div class="banner-section">
                ...
                @foreach ($data['banner'] as $key => $row)
                    <div class="carousel-item position-relative {{ $key == 0 ? 'active' : '' }}">
                        <div class="banner-wrapper">
                            <img src="{{ asset($row->image) }}" class="d-block w-100 banner-img" alt="Banner Image">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                   <div class="col-lg-10 px-4 text-center">
                    ...
                    <a href="{{ route('site.about') }}" class="button-more-seeaa mt-3 px-3">Why NehanTech Solution?<i
                        ...
                        @if (isset($data['featured_pages'][0]))
                            ...
                            @foreach ($data['files']->slice(0, 4) as $f)
                                <div class="col-lg-3 col-md-3 mb-4">
                                    <a href="{{ asset($f->file) }}" data-lightbox="models" data-title="caption1"
                                        class="glightbox">
                                        <img src="{{ asset($f->file) }}" class="img-fluid rounded" alt="Event 1" style="height: 300px;">
                                    </a>
                                </div>
                            @endforeach
                        @else
    ...
    <section class="services-section-a">
        <div class="container py-lg-3 py-2">
            ...
            <p class="mb-lg-5 mb-3 text-center text-white">We Put Quality and Professionalism Above Every Else</p>
            <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            <a href="{{ route('site.services.show', ['id' => $row->id]) }}" class="Live-Event-Management">
                                <div class="service-box d-flex align-items-center justify-content-between hover-box">
                                    ...
                                    <img src="{{ $row->image }}" class="img-fluid" alt="Live Event Management">
                                </div>
                            </a>
                        </div>
                    @endforeach
