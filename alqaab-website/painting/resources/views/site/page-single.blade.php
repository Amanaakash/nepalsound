...
<section class="our-blog-red"
  style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.8),rgba(0, 0, 0, 0.8)), url({{ asset($data['single']->thumbs) }}) no-repeat center center; background-size: cover; position: relative; height: 300px;">
  <div class="container">
    <div class="text-white py-3">
      @if(isset($data['single']->title))
        <p class="py-4">{{ $data['single']->title }} rthis is test</p>
