        ...
        <form action="{{ route($_base_route.'.update', $data['rows']->post_unique_id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="ibox">
                        <div class="ibox-head">
                            <div class="ibox-title">Book Create</div>
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" cols="30" rows="9" id="my-editor-1" class="form-control rounded short">@if(isset($data['rows']->short_description)) {{ $data['rows']->short_description   }} @endif</textarea>
                            </div>
                        </div>
                    </div>
                </div>
