    ...
    <div class="row">
        <div class="col-md-6">
            <div class="d-sm-flex align-items-center mb-4">
                <a href="{{route( $_base_route.'.create' )}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> New Book </a> &nbsp;
                <a href="{{route('admin.bookcover.index' )}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" style="float: left;"><i class="fa fa-book fa-sm text-white-50"></i> Book Cover</a>
            </div>
        </div>
        <div class="col-md-6">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @include('admin.section.buttons.button-edit-book')
                                    @endif
                                    @if(Route::has($_base_route.'.edit'))
