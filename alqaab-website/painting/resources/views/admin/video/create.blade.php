                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" name="video_title" id="video_title" value="{{ old('video_title') }}" placeholder="Video Title">
                            </div>
                            <div class="form-group">
                                <label for="video_url">Youtube Video Url</label>
                                <input class="form-control rounded" type="url" name="video_url" id="video_url" value="{{ old('video_url') }}" placeholder="Video url">
                            </div>
                            <div class="form-group">
