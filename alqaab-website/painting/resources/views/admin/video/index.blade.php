        ...
        <div class="ibox-body">
            <div class="tab-content">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><iframe src="https://www.youtube.com/embed/<?php echo $row->video_id;?>" frameborder="0"></iframe></td>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6"><span class="pull-right">{{$data['rows']->links()}}</span></div>
                </div>
            </div>
        </div>
    </div>
