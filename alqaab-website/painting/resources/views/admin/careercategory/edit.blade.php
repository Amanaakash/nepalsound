                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="title" value="{{ $data['row']->title }}" placeholder="Category Name">
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="ui-checkbox">
                                            ...
                                            <input type="checkbox" name="status" value=1 {{ $data['row']-> status ? 'checked' : '' }}><span class="input-span"></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
