                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody id="tablecontents">
                            ...
                            <tr class="row1" data-id="{{ $row->id }}">
                                ...
                                <td>
                                    @if($row->thumbs)
                                    <img src="{{$row->thumbs}}" class="img tmg-responsive img-thumnail" alt="" width="50px">
                                    @else
                                    <p>Image Not Found !</p>
                                    @endif
                                </td>
                                ...
                                <td>
                                    @if($row->featured == 1)
                                    <span class="badge badge-success badge-pill m-r-5 m-b-5">Yes</span>
                                    @else
                                    <span class="badge badge-warning badge-pill m-r-5 m-b-5">No</span>
                                    @endif
                                </td>
                                <td>
