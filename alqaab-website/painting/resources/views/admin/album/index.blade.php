...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div class="row">
            ...
            <a href="{{route( $_base_route.'.index' )}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fa fa-refresh"></i> Refresh</a>
        </div>
    </div>
    <div class="ibox">
        <div class="ibox-head">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->title }}</td>
                                <td>
                                    @if(isset($row->$row->postCategory))
                                    {{ $row->postCategory->title }}
                                    @else
                                    Post Not found !
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a href="{{ route('admin.photos.create', $row->id) }}" class="btn btn-info btn-sm"><i class="fa fa-plus fa-sm text-white-50"></i> Add Photo to Album</a>
                                <td>
