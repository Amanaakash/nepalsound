...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="{{route( $_base_route.'.create' )}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-plus fa-sm text-white-50"></i> New Career </a>
    </div>
    <div class="ibox">
        <div class="ibox-head">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('/upload_file/career/' . $row->image)}}" class="img tmg-responsive img-thumnail" alt="{{ $row->title}}" width="50px">
                                </td>
