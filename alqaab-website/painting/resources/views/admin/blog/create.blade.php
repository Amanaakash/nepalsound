                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" cols="30" rows="9" id="my-editor-1" class="form-control rounded short">{{ old('short_description') }}</textarea>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input class="form-control" type="text" value="{{ old('publish_date') }}" id="publish_date" name="publish_date" va>
                                    </div>
                                </div>
                                <div class="form-group ">
