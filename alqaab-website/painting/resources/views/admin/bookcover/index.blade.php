    ...
    <div class="row">
        <div class="col-md-6">
            <div class="d-sm-flex align-items-center mb-4">
                <a href="{{route( 'admin.book.index' )}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-book fa-sm text-white-50"></i> Book List </a> &nbsp;
                <a href="{{route( $_base_route.'.index' )}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" style="float: left;"><i class="fa fa-book fa-sm text-white-50"></i> Book Cover</a>&nbsp;
                <a href="{{route( $_base_route.'.create' )}}" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm" style="float: left;"><i class="fa fa-plus fa-sm text-white-50"></i> Add New</a>
            </div>
        </div>
        <div class="col-md-6">
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if(Route::has($_base_route.'.edit'))
                                    @include('admin.section.buttons.button-edit-bookcover')
                                    @endif
