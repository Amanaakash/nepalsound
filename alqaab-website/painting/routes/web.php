...
Route::get('/albums', [App\Http\Controllers\Site\SiteController::class, 'albums'])
    ->name('albums');
// Route for Albums Page
//Route::get('/albums', [App\Http\Controllers\Site\SiteController::class, 'albums'])
   // ->name('albums');
...
// Gallery main page
Route::get('/gallery', [App\Http\Controllers\Site\SiteController::class, 'albums'])
    ->name('gallery');
  // Temp route for test
//Route::get('/gallery-test', [App\Http\Controllers\Site\SiteController::class, 'albums'])
   // ->name('gallery.test');
//re-route test
Route::get('/gallery-test', function () {
    return 'GALLERY TEST WORKS';
});
// Photos inside an album
Route::get('/gallery/{id}', [App\Http\Controllers\Site\SiteController::class, 'gallery'])
    ->name('photos.show');
