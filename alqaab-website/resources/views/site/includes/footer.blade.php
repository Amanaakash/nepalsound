...
s1.async=true;
s1.src='https://embed.tawk.to/6993bce08a94111c3969aec1/1jhkhjjo1';
s1.charset='UTF-8';
        ...
        <div class="row ">
            ...
            <div class="col-lg-4 col-md-12 footer-logo">
                ...
                <a href="{{ route('site.index')}}">
                    <img src="{{ asset(\App\Support\SitePresentation::logoPath($all_view['setting']->logo)) }}" alt="Logo">
                </a>
                @endif
...
<i class="bi bi-circle"></i> &nbsp {{$service->title }}
                            </a>
                        </li>
                    @empty
