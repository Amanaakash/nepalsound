...
<div class="container-fluid">
    ...
    <div class="d-sm-flex  mb-4">
        ...
        <a href="{{route('admin.servicescover.index' )}}" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fa fa-refresh fa-sm text-white-50"></i> {{ $_panel }} Cover Slider </a>
