                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Category Name">
                            </div>
                            <div class="form-group">
                                <label for="title">Images</label>
                                <input class="form-control" type="file" name="thumbs" id="thumbs" value="" placeholder="Product Url" accept="image/png, image/gif, image/jpeg">
                            </div>
                            <div class="form-group">
