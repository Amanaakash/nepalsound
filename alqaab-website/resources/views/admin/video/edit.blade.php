                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                <label for="video_title">Banner Name</label>
                                <input class="form-control rounded" type="text" name="video_title" id="video_title" value="@if(isset($data['rows']->video_title)) {{ $data['rows']->video_title   }} @endif" placeholder="Video Title">
                            </div>
                           
                            <div class="form-group">
                                <label for="url">Youtube Video Url</label>
                                <input class="form-control rounded" type="url" name="video_url" id="video_url" value="@if(isset($data['rows']->video_url)) {{ $data['rows']->video_url   }} @endif" placeholder="Video url">
                            </div>
