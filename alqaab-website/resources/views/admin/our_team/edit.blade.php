...
<div class="card shadow mb-4">
    <div class="card-body">
       <form action="{{ route('admin.our-team.update', $team) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12">
                    <div class="ibox">
                        <div class="ibox-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="text" name="designation" class="form-control" 
                                        value="{{ old('designation', $team->designation) }}" placeholder="E.g. CEO, Developer">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if($team->image)
                                <div class="mt-2">
                                    <img src="{{ asset($team->image) }}" width="150" class="img-thumbnail">
