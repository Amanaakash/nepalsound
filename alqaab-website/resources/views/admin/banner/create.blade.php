                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control rounded" type="text" name="title_second" id="title_second" value="{{ old('title_second') }}" placeholder="Banner Name Second">
                            </div>
                            <div class="form-group">
                                <label for="title">Banner Description</label>
                                <textarea name="description" cols="2" rows="2" id="my-editor-1" class="form-control rounded" value="">{{ old('description') }}</textarea>
                            </div>
                            <div class="form-group">
