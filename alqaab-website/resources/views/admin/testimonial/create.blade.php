                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Title">
                                </div>
                                <!-- <div class="form-group col-md-12">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="my-editor-1" cols="30" rows="5" class="form-control rounded" value="" placeholder="Description ">{{ old('description') }}</textarea>
                                </div>
                                <div class="form-group col-md-12">
