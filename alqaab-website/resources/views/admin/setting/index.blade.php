            ...
            <div class="row" style="font-weight: bold;">
                <div class="col-md-3">
                    <div class="form-group">
                        <label>CMS Title</label> <br>
                        <input class="form-control rounded" type="text" id="cms_title" value="@if(isset($data['setting']->cms_title)) {{ $data['setting']->cms_title }} @else {{ old('cms_title') }} @endif" name="cms_title" placeholder="नाम">
                        @if($errors->has('cms_title'))
                        <p id="name-error" class="help-block" for="cms_title"><span>{{ $errors->first('cms_title') }}</span></p>
                        @endif
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>First Title</label> <br>
                        <input class="form-control rounded" type="text" id="first_title" value="@if(isset($data['setting']->first_title)) {{ $data['setting']->first_title }} @else {{ old('first_title') }} @endif" name="first_title" placeholder="नाम">
                        @if($errors->has('first_title'))
                        <p id="name-error" class="help-block" for="first_title"><span>{{ $errors->first('first_title') }}</span></p>
                        @endif
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Second Title</label> <br>
                        <input class="form-control rounded" type="text" id="second_title" value="@if(isset($data['setting']->second_title)) {{ $data['setting']->second_title }} @else {{ old('second_title') }} @endif" name="second_title" placeholder="नाम">
                        @if($errors->has('second_title'))
                        <p id="name-error" class="help-block" for="second_title"><span>{{ $errors->first('second_title') }}</span></p>
                        @endif
                    </div>
                </div>
                <div class="col-md-3">
